...
- Mutation testing (Sail / Infection, pilot): `npm run sail:infection` / `composer test:infection` mutates `Support` + `Policies` only (`infection.json5`); HTML/log under `coverage/infection*`. Covered MSI baseline **82.56%** (2026-09-16). No MSI CI gate yet.
